...
class UiMenu(HelpMenu):
    ...
    def __init__(self):
        ...
        # Engram :
        self.menuDispEngram.triggered.connect(self._fcn_menu_disp_engram)
        # Cross-sections :
    ...
    def _fcn_menu_disp_engram(self):
        """Display/hide the main Engram."""
        viz = self.menuDispEngram.isChecked()
        self._engram_grp.setChecked(viz)
    ...
    def _fcn_set_cam_fly(self):
        ...
        the engram (not easy to control).
        """
